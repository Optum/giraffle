...
----
plugins {
    id("com.optum.giraffle") version "1.0.0"
}
----
...
dependencies {
    gsqlRuntime("com.tigergraph.client:gsql_client:2.3.2") // <2>
    gsqlRuntime("javax.xml.bind:jaxb-api:2.3.1") // <3>
...
<3> You may, or may not need this. It depends on the version of the Java
runtime you're using. If you get an error, try adding this to your
`gsqlRuntime` dependency.
